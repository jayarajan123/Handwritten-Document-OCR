  ...
  return (
    <div className="min-h-screen bg-paper-50 dark:bg-ink-950 text-ink-900 dark:text-paper-100 flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <p className="text-center text-sm text-ink-900/60 dark:text-paper-100/60 mb-8">Log in to your notes</p>
        ...
        <p className="text-center text-sm mt-6 text-ink-900/60 dark:text-paper-100/60">
          No account? <Link to="/register" className="text-violet-600 dark:text-violet-300 font-medium">Sign up</Link>
        </p>
      </div>
    </div>
  );
